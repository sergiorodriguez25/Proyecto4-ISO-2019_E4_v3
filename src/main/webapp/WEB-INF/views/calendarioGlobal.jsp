...
<script>
	var calendar = new Calendar("calendarContainer", "small", [ "Lunes", 3 ], [
			"#ab2a3e", "641c34", "#ffffff", "#ffecb3" ], {
	...
	calendar.setOnClickListener('days-blocks', function() {
				...
				$('#listaCitas')
						.append(
								"<a id=filas class=list-group-item list-group-item-action flex-column align-items-start active><div class=d-flex w-100 justify-content-between><h5 class=mb-1>Día: "
										...
										+ ", Hora: "
										+ hora
										+ "</h5></div><p class=mb-1>Dr. "
										+ nombreMedico
										+ " "
										+ apellidosMedico
										+ " tiene una cita con el/la paciente "
										+ nombrePaciente
										+ " "
										+ apellidosPaciente + ".</p></a>");
			}
		}
	}
