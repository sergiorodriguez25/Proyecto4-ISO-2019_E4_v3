 ...
 * Generated at: 2019-11-26 08:42:22 UTC
...
public final class formularioModificar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\taria-disabled=\"true\">Mis citas</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tencontrará a continuación, después pulse en el botón de\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tModificar cita.</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tPara modificar una cita, cambie los campos que encontrará a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tcontinuación, después pulse en el botón de Modificar cita.\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label id=\"especialidad\"></label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<br></br>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t<a id=\"modificarcita\" class=\"btn btn-primary btn-large\"\r\n");
      out.write("\t\t\t\t\t\t\ttype=\"submit\">Modificar cita</a> <a id=\"volverAtras\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\tif (referrer == 'http://localhost:8080/medicoGestor'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t|| referrer != 'https://the-good-health.herokuapp.com/medicoGestor') {\r\n");
      out.write("\t\t\t\t\t\t\t\tdocument.getElementById(\"tituloespecialidad\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar dateObject = new Date(+dateParts[2],\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdateParts[1] - 1, +dateParts[0]);\r\n");
      out.write("\t\t\t\t\t\t\tvar diaSemana = weekday[dateObject.getDay()];\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$('#especialidad').html(espec);\r\n");
      out.write("\t\t\t\t\t\t\t$('#fecha_ini')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.datepicker('setDate', diaAModificar);\r\n");
      ...
      out.write("\t\t\t\t\t\t\tgetHorasCitasDiaSeleccionado(diaAModificar,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdniMedico);\r\n");
      out.write("\t\t\t\t\t\t\tvar jsoHorasOcu = JSON\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.parse(sessionStorage.horasOcupadas);\r\n");
      out.write("\t\t\t\t\t\t\tvar horasOcupadas = jsoHorasOcu.horas;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\tvar horasOcupadasSinActual = new Array(\r\n");
      out.write("\t\t\t\t\t\t\t\t\thorasOcupadas.length - 1);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn horasOcupadasSinActual\r\n");
      ...
      out.write("\t\t\t\t.ready(\r\n");
      out.write("\t\t\t\t\t\tfunction($) {\r\n");
      out.write("\t\t\t\t\t\t\t$('#volverAtras')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.click(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfunction(event) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tevent.preventDefault();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvar referrer = document.referrer;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tif (referrer == 'http://localhost:8080/citasGestor'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t|| referrer == 'https://the-good-health.herokuapp.com/citasGestor') {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tlocation.href = \"/citasGestor\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t} else if (referrer == 'http://localhost:8080/medicoGestor'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t|| referrer == 'https://the-good-health.herokuapp.com/medicoGestor') {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tweekday[5] = \"Viernes\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tweekday[6] = \"Sábado\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvar dateParts = $('#fecha_ini')\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t.val().split(\"/\");\r\n");
      ...
      out.write("\t\t\tvar dniPac;\r\n");
      out.write("\t\t\tvar referrer = document.referrer;\r\n");
      out.write("\t\t\tif (referrer == \"http://localhost:8080/citasGestor\"\r\n");
      out.write("\t\t\t\t\t|| referrer == \"https://the-good-health.herokuapp.com/citasGestor\") {\r\n");
      out.write("\t\t\t\tvar jsoEdit = JSON.parse(sessionStorage.PacienteEdit);\r\n");
      out.write("\t\t\t\tdniPac = jsoEdit.Paciente[0].DNI;\r\n");
      out.write("\t\t\t} else if (referrer == \"http://localhost:8080/medicoGestor\"\r\n");
      out.write("\t\t\t\t\t|| referrer == \"https://the-good-health.herokuapp.com/medicoGestor\")\r\n");
      out.write("\t\t\t\tdniPac = jsoModif.citaModificar[0].dniPaciente;\r\n");
      out.write("\t\t\telse\r\n");
      out.write("\t\t\t\tdniPac = jsoUser.resultado.usuario.dni;\r\n");
      out.write("\t\t\tvar data = {\r\n");
      out.write("\t\t\t\tdniPaciente : dniPac,\r\n");
